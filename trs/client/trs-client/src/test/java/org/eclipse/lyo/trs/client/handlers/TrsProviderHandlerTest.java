...
public class TrsProviderHandlerTest {
  ...
  private static final String bmUriPrefix = uriPrefix + "/baseMembers";
  ...
  public void setUp() throws Exception {
    trsProvider =
        new TrsProviderHandler(
            RDF_NIL, new TrackedResourceClient(new OslcClient()), new TestProviderHandler());
  ...
  public final void testOptimizedChangesList() throws URISyntaxException {
    ...
    List<ChangeEvent> changeEventsList = ProviderUtil.optimizedChangesList(changeLogsList, null);
