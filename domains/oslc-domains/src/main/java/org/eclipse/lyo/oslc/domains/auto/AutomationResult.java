...
public class AutomationResult extends AbstractResource implements IAutomationResult {
  ...
  public String toString(boolean asLocalResource) {
    ...
    if (asLocalResource) {
      result =
          result
              + "{a Local AutomationResult Resource} - update AutomationResult.toString() to"
  ...
  @OslcDescription(
      "Used to indicate the state of the automation request based on values defined by the service"
          + " provider. Most often a read-only property. It is expected that this will be a"
          + " resource reference to a definition of a valid automation request state on the service"
          + " provider.")
  ...
  @OslcDescription(
      "Used to indicate the desired state of the Automation Request based on values defined by the"
          + " service provider. It is expected that this will be a resource reference to a"
          + " definition of a valid automation request state on the service provider.")
  @OslcOccurs(Occurs.ZeroOrOne)
  @OslcValueType(ValueType.Resource)
  @OslcReadOnly(false)
  ...
  @OslcDescription(
      "Used to indicate the verdict of the automation result based on values defined by the service"
          + " provider. Most often a read-only property. It is expected that this will be a"
          + " resource reference to a definition of a valid automation result verdict on the"
          + " service provider.")
  @OslcOccurs(Occurs.OneOrMany)
  @OslcValueType(ValueType.Resource)
  @OslcReadOnly(false)
  ...
  @OslcDescription(
      "A result contribution associated with this automation result. It is recommended that the"
          + " contribution be an inline resource which can be retrieved with the automation result."
          + " The recommended attributes beyond the contribution itself are dcterms:title,"
          + " dcterms:description and dcterms:type to provide a description of the contribution"
          + " which would be appropriate for display in a simple UI for an automation result.")
  @OslcOccurs(Occurs.ZeroOrMany)
  @OslcValueType(ValueType.Resource)
  @OslcReadOnly(false)
  ...
  @OslcDescription(
      "Parameters provided when Automation Requests are created. These include parameters provided"
          + " by the creator of the Automation Request (whether by delegated UI or HTTP POST) and"
          + " MAY include additional parameters added by the service provider during Automation"
          + " Request creation. See the definition of the oslc_auto:parameterDefinition attribute"
          + " of the Automation Plan for additional guidance on determining which parameters are"
          + " required. Creators of Automation Requests MAY provide parameters beyond those defined"
          + " in the Automation Plan without guarantee the service provider will recognize or honor"
          + " them. It is expected that this attribute is write-able on Automation Request creation"
  ...
  @OslcDescription(
      "Automation Result output parameters are parameters associated with the automation execution"
          + " which produced this Result. This includes the final value of all parameters used to"
          + " initiate the execution and any additional parameters which may have been created"
          + " during automation execution by the service provider or external agents. The value of"
          + " a given oslc_auto:outputParameter MAY change as the execution proceeds. Point-in-time"
          + " accuracy of the values of output parameters is not covered by this specification."
          + " Once the Automation Result is in a final state ( oslc_auto:complete or"
          + " oslc_auto:canceled), the oslc_auto:outputParameter values MUST NOT change.")
  @OslcOccurs(Occurs.ZeroOrMany)
  @OslcValueType(ValueType.Resource)
  @OslcRange({Oslc_autoDomainConstants.PARAMETERINSTANCE_TYPE})
  @OslcReadOnly(false)
  ...
  @OslcDescription(
      "Automation Plan which the Automation Result reports on. It is likely that the target"
          + " resource will be an oslc_auto:AutomationPlan but that is not necessarily the case.")
  @OslcOccurs(Occurs.ExactlyOne)
  @OslcValueType(ValueType.Resource)
  @OslcRepresentation(Representation.Reference)
