...
@OslcSchema({
  ...
  @OslcNamespaceDefinition(
      prefix = Oslc_rmVocabularyConstants.REQUIREMENTS_MANAGEMENT_VOCABULARY_NAMSPACE_PREFIX,
      namespaceURI = Oslc_rmVocabularyConstants.REQUIREMENTS_MANAGEMENT_VOCABULARY_NAMSPACE),
})
