...
public interface Oslc_qmDomainConstants {
    ...
    public static String QUALITY_MANAGEMENT_NAMSPACE =
            "http://open-services.net/ns/qm#"; // Vocabulary namespace for the resources and
    ...
    public static String QUALITY_MANAGEMENT_NAMSPACE_PREFIX =
            "oslc_qm"; // Vocabulary prefix for the resources and resource properties, when no
    ...
    public static String TESTCASE_NAMESPACE =
            Oslc_qmVocabularyConstants
                    .QUALITY_MANAGEMENT_NAMSPACE; // namespace of the rdfs:class the resource
    // describes
    public static String TESTCASE_LOCALNAME =
            Oslc_qmVocabularyConstants
                    .TESTCASE; // localName of the rdfs:class the resource describes
    public static String TESTCASE_TYPE =
            TESTCASE_NAMESPACE
                    + TESTCASE_LOCALNAME; // fullname of the rdfs:class the resource describes
    ...
    public static String TESTEXECUTIONRECORD_TYPE =
            TESTEXECUTIONRECORD_NAMESPACE
                    + TESTEXECUTIONRECORD_LOCALNAME; // fullname of the rdfs:class the resource
    // describes
    ...
    public static String TESTPLAN_LOCALNAME =
            Oslc_qmVocabularyConstants
                    .TESTPLAN; // localName of the rdfs:class the resource describes
    public static String TESTPLAN_TYPE =
            TESTPLAN_NAMESPACE
                    + TESTPLAN_LOCALNAME; // fullname of the rdfs:class the resource describes
    ...
    public static String TESTRESULT_LOCALNAME =
            Oslc_qmVocabularyConstants
                    .TESTRESULT; // localName of the rdfs:class the resource describes
    ...
    public static String TESTSCRIPT_LOCALNAME =
            Oslc_qmVocabularyConstants
                    .TESTSCRIPT; // localName of the rdfs:class the resource describes
