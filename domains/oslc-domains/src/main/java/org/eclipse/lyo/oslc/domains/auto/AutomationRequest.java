...
public class AutomationRequest extends AbstractResource implements IAutomationRequest {
    ...
    public String toString(boolean asLocalResource) {
        ...
        if (asLocalResource) {
            result =
                    result
                            + "{a Local AutomationRequest Resource} - update"
                            + " AutomationRequest.toString() to present resource as desired.";
    ...
    @OslcDescription(
            "Automation Plan run by the Automation Request. It is likely that the target resource"
