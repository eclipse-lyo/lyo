...
@OslcResourceShape(
    title = "AutomationRequest Shape",
    describes = Oslc_autoDomainConstants.AUTOMATIONREQUEST_TYPE)
public class AutomationRequest extends AbstractResource implements IAutomationRequest {
  ...
  public String toString(boolean asLocalResource) {
    ...
    if (asLocalResource) {
      result =
          result
              + "{a Local AutomationRequest Resource} - update AutomationRequest.toString() to"
  ...
  @OslcDescription(
      "Automation Plan run by the Automation Request. It is likely that the target resource will be"
          + " an oslc_auto:AutomationPlan but that is not necessarily the case.")
  @OslcOccurs(Occurs.ExactlyOne)
  @OslcValueType(ValueType.Resource)
  @OslcRepresentation(Representation.Reference)
