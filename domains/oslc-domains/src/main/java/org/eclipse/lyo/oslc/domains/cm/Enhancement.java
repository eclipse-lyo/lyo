...
// End of user code
@OslcNamespace(Oslc_cm_shapesDomainConstants.ENHANCEMENT_NAMESPACE)
@OslcName(Oslc_cm_shapesDomainConstants.ENHANCEMENT_LOCALNAME)
@OslcResourceShape(
    title = "Enhancement Shape",
    describes = Oslc_cm_shapesDomainConstants.ENHANCEMENT_TYPE)
public class Enhancement extends ChangeRequest implements IEnhancement {
  ...
  public String toString(boolean asLocalResource) {
    ...
    if (asLocalResource) {
      result =
          result
              + "{a Local Enhancement Resource} - update Enhancement.toString() to present resource"
              + " as desired.";
