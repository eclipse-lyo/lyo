...
@OslcResourceShape(
        ...
        description =
                "An IssueCollection is a resource which is a subclass of ManagedItemCollection. An"
                        + " IssueCollection only collects Issues. All of Issues raised in a project"
                        + " should be collected by an IssueCollection.",
...
public class IssueCollection extends ManagedItemCollection implements IIssueCollection {
    ...
    public String toString(boolean asLocalResource) {
        ...
        if (asLocalResource) {
            result =
                    result
                            + "{a Local IssueCollection Resource} - update"
                            + " IssueCollection.toString() to present resource as desired.";
