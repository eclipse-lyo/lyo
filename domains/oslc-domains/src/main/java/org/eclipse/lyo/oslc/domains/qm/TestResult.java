...
public class TestResult extends AbstractResource implements ITestResult {
  ...
  public String toString(boolean asLocalResource) {
    ...
    if (asLocalResource) {
      result =
          result
              + "{a Local TestResult Resource} - update TestResult.toString() to present resource"
              + " as desired.";
  ...
  @OslcDescription(
      "Change request that affects the Test Result. It is likely that the target resource will be"
  ...
  @OslcDescription(
      "Test Script executed to produce the Test Result. It is likely that the target resource will"
          + " be an oslc_qm:TestScript but that is not necessarily the case.")
  @OslcOccurs(Occurs.ZeroOrOne)
  @OslcValueType(ValueType.Resource)
  ...
  @OslcPropertyDefinition(
      Oslc_qmVocabularyConstants.QUALITY_MANAGEMENT_NAMSPACE + "producedByTestExecutionRecord")
  @OslcDescription(
      "Test Execution Record that the Test Result was produced by. It is likely that the target"
          + " resource will be an oslc_qm:TestExecutionRecord but that is not necessarily the"
          + " case.")
  @OslcOccurs(Occurs.ZeroOrOne)
  @OslcValueType(ValueType.Resource)
  ...
  @OslcDescription(
      "Test Case that the Test Result reports on. It is likely that the target resource will be an"
  ...
  @OslcDescription(
      "Test Plan that the Test Execution Record reports on. It is likely that the target resource"
          + " will be an oslc_qm:TestPlan but that is not necessarily the case.")
  @OslcOccurs(Occurs.ZeroOrOne)
  @OslcValueType(ValueType.Resource)
