...
@OslcSchema ({
    ...
    @OslcNamespaceDefinition(prefix = Oslc_qmVocabularyConstants.QUALITY_MANAGEMENT_NAMSPACE_PREFIX, namespaceURI = Oslc_qmVocabularyConstants.QUALITY_MANAGEMENT_NAMSPACE),
})
