...
@OslcSchema ({
    ...
    @OslcNamespaceDefinition(prefix = Oslc_configVocabularyConstants.OSLC_CONFIGURATION_MANAGEMENT_NAMSPACE_PREFIX, namespaceURI = Oslc_configVocabularyConstants.NS),
})
