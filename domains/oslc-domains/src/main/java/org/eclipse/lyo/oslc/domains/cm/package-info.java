...
@OslcSchema({
  ...
  @OslcNamespaceDefinition(
      prefix = Oslc_cm_shapesDomainConstants.CHANGE_MANAGEMENT_SHAPES_NAMSPACE_PREFIX,
      namespaceURI = Oslc_cm_shapesDomainConstants.CHANGE_MANAGEMENT_SHAPES_NAMSPACE),
})
