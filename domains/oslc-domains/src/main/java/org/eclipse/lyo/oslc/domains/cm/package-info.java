...
@OslcSchema ({
    ...
    @OslcNamespaceDefinition(prefix = Oslc_cmVocabularyConstants.CHANGE_MANAGEMENT_VOCAB_NAMSPACE_PREFIX, namespaceURI = Oslc_cmVocabularyConstants.CHANGE_MANAGEMENT_VOCAB_NAMSPACE),
})
