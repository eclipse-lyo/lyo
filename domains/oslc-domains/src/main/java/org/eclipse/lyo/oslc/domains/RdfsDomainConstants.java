...
public interface RdfsDomainConstants {
    ...
    public static String CLASS_NAMESPACE =
            RdfsVocabularyConstants
                    .RDFS_NAMSPACE; // namespace of the rdfs:class the resource describes
    public static String CLASS_LOCALNAME =
            RdfsVocabularyConstants.RDFSCLASS; // localName of the rdfs:class the resource describes
