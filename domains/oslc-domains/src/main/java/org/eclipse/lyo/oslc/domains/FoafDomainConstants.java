...
public interface FoafDomainConstants
{
    ...
    public static String AGENT_NAMESPACE = FoafVocabularyConstants.NS;
    
    // localName of the rdfs:class the resource describes
    public static String AGENT_LOCALNAME = FoafVocabularyConstants.AGENT_LOCAL_NAME;
    ...
    // namespace of the rdfs:class the resource describes
    public static String PERSON_NAMESPACE = FoafVocabularyConstants.NS;
    
    // localName of the rdfs:class the resource describes
    public static String PERSON_LOCALNAME = FoafVocabularyConstants.PERSON_LOCAL_NAME;
