...
public interface Oslc_amDomainConstants {
  ...
  public static String ARCHITECTURE_MANAGEMENT_NAMSPACE =
      "http://open-services.net/ns/am#"; // Vocabulary namespace for the resources and resource
  ...
  public static String ARCHITECTURE_MANAGEMENT_NAMSPACE_PREFIX =
      "oslc_am"; // Vocabulary prefix for the resources and resource properties, when no explicit
  ...
  public static String LINKTYPE_NAMESPACE =
      Oslc_amDomainConstants
          .ARCHITECTURE_MANAGEMENT_NAMSPACE; // namespace of the rdfs:class the resource describes
  ...
  public static String LINKTYPE_TYPE =
      LINKTYPE_NAMESPACE + LINKTYPE_LOCALNAME; // fullname of the rdfs:class the resource describes
  ...
  public static String RESOURCE_TYPE =
      RESOURCE_NAMESPACE + RESOURCE_LOCALNAME; // fullname of the rdfs:class the resource describes
}
