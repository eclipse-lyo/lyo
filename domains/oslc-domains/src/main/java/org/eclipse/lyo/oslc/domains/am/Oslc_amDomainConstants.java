...
public interface Oslc_amDomainConstants {
  ...
  public static String LINKTYPE_NAMESPACE = Oslc_amDomainConstants.ARCHITECTURE_MANAGEMENT_NAMSPACE;

  // localName of the rdfs:class the resource describes
  public static String LINKTYPE_LOCALNAME = "LinkType";

  // fullname of the rdfs:class the resource describes
  public static String LINKTYPE_TYPE = LINKTYPE_NAMESPACE + LINKTYPE_LOCALNAME;
  // the relative path of the resource shape URL.
  public static String RESOURCE_PATH = "resource";

  // namespace of the rdfs:class the resource describes
  public static String RESOURCE_NAMESPACE = Oslc_amDomainConstants.ARCHITECTURE_MANAGEMENT_NAMSPACE;

  // localName of the rdfs:class the resource describes
  public static String RESOURCE_LOCALNAME = "Resource";

  // fullname of the rdfs:class the resource describes
  public static String RESOURCE_TYPE = RESOURCE_NAMESPACE + RESOURCE_LOCALNAME;
}
