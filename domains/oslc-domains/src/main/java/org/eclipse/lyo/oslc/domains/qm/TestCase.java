...
public class TestCase extends AbstractResource implements ITestCase {
  ...
  public String toString(boolean asLocalResource) {
    ...
    if (asLocalResource) {
      result =
          result
              + "{a Local TestCase Resource} - update TestCase.toString() to present resource as"
              + " desired.";
  ...
  @OslcDescription(
      "Change Request tested by the Test Case. It is likely that the target resource will be an"
          + " oslc_cm:ChangeRequest but that is not necessarily the case.")
  @OslcOccurs(Occurs.ZeroOrMany)
  @OslcValueType(ValueType.Resource)
  @OslcRepresentation(Representation.Reference)
