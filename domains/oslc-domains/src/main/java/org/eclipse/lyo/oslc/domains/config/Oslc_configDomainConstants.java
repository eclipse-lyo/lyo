...
public interface Oslc_configDomainConstants
{
    ...
    public static String BASELINE_NAMESPACE = CONFIGURATION_MANAGEMENT_NAMSPACE; //namespace of the rdfs:class the resource describes
    ...
    public static String COMPONENT_NAMESPACE = CONFIGURATION_MANAGEMENT_NAMSPACE; //namespace of the rdfs:class the resource describes
    ...
    public static String CONCEPTRESOURCE_NAMESPACE = CONFIGURATION_MANAGEMENT_NAMSPACE; //namespace of the rdfs:class the resource describes
    ...
    public static String CONTRIBUTION_NAMESPACE = CONFIGURATION_MANAGEMENT_NAMSPACE; //namespace of the rdfs:class the resource describes
    ...
    public static String SELECTIONS_NAMESPACE = CONFIGURATION_MANAGEMENT_NAMSPACE; //namespace of the rdfs:class the resource describes
    ...
    public static String STREAM_NAMESPACE = CONFIGURATION_MANAGEMENT_NAMSPACE; //namespace of the rdfs:class the resource describes
