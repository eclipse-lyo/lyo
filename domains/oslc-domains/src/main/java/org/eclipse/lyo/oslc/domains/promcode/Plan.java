...
@OslcResourceShape(
        title = "Plan Shape",
        description =
                "A Plan is a resource which is a subclass of ManagedItemCollection to describe a"
                    + " plan, which is agreed between an acquirer and a supplier at project"
                    + " initiation. A plan consists of ScopeItems, WorkItems, Artifacts, Targets"
                    + " and Measures.",
        describes = Oslc_promcodeDomainConstants.PLAN_TYPE)
public class Plan extends ManagedItemCollection implements IPlan {
    ...
    public String toString(boolean asLocalResource) {
        ...
        if (asLocalResource) {
            result =
                    result
                            + "{a Local Plan Resource} - update Plan.toString() to present resource"
                            + " as desired.";
