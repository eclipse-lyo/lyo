...
@OslcSchema({
  ...
  @OslcNamespaceDefinition(
      prefix = FoafVocabularyConstants.FOAF_NAMSPACE_PREFIX,
      namespaceURI = FoafVocabularyConstants.FOAF_NAMSPACE),
  @OslcNamespaceDefinition(
      prefix = RdfsVocabularyConstants.RDFS_NAMSPACE_PREFIX,
      namespaceURI = RdfsVocabularyConstants.RDFS_NAMSPACE),
})
