...
@OslcSchema ({
    ...
    @OslcNamespaceDefinition(prefix = FoafVocabularyConstants.FOAF_NAMSPACE_PREFIX, namespaceURI = FoafVocabularyConstants.NS),
    @OslcNamespaceDefinition(prefix = RdfsVocabularyConstants.RDFS_NAMSPACE_PREFIX, namespaceURI = RdfsVocabularyConstants.NS),
})
