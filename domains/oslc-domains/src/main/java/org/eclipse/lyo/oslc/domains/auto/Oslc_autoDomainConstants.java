...
public interface Oslc_autoDomainConstants {
    ...
    public static String AUTOMATION_NAMSPACE =
            "http://open-services.net/ns/auto#"; // Vocabulary namespace for the resources and
    ...
    public static String AUTOMATION_NAMSPACE_PREFIX =
            "oslc_auto"; // Vocabulary prefix for the resources and resource properties, when no
    ...
    public static String AUTOMATIONREQUEST_TYPE =
            AUTOMATIONREQUEST_NAMESPACE
                    + AUTOMATIONREQUEST_LOCALNAME; // fullname of the rdfs:class the resource
    // describes
    ...
    public static String AUTOMATIONRESULT_TYPE =
            AUTOMATIONRESULT_NAMESPACE
                    + AUTOMATIONRESULT_LOCALNAME; // fullname of the rdfs:class the resource
    // describes
    ...
    public static String PARAMETERINSTANCE_TYPE =
            PARAMETERINSTANCE_NAMESPACE
                    + PARAMETERINSTANCE_LOCALNAME; // fullname of the rdfs:class the resource
    // describes
}
