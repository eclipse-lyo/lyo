    ...
    implements ITestPlan
{
  ...
  // End of user code
    ...
    @OslcPropertyDefinition(Oslc_qmVocabularyConstants.USESTESTCASE_PROP)
  ...
  // End of user code
    ...
    @OslcPropertyDefinition(Oslc_qmVocabularyConstants.VALIDATESREQUIREMENTCOLLECTION_PROP)
