...
public interface RmConstants {
    ...
    public static String TYPE_REQUIREMENT_COLLECTION =
            REQUIREMENTS_MANAGEMENT_NAMESPACE + "RequirementCollection";
    ...
    QName PROPERTY_ACCESS_CONTROL =
            new QName(RmConstants.JAZZ_RM_ACCESS_NAMESPACE, "accessControl");

    public static final BaseDatatype RDF_TYPE_BOOLEAN =
            new BaseDatatype(OslcConstants.RDF_NAMESPACE + "boolean");
    public static final BaseDatatype RDF_TYPE_DATETIME =
            new BaseDatatype(OslcConstants.RDF_NAMESPACE + "dateTime");
    public static final BaseDatatype RDF_TYPE_DECIMAL =
            new BaseDatatype(OslcConstants.RDF_NAMESPACE + "decimal");
    public static final BaseDatatype RDF_TYPE_DOUBLE =
            new BaseDatatype(OslcConstants.RDF_NAMESPACE + "double");
    public static final BaseDatatype RDF_TYPE_FLOAT =
            new BaseDatatype(OslcConstants.RDF_NAMESPACE + "float");
    public static final BaseDatatype RDF_TYPE_INTEGER =
            new BaseDatatype(OslcConstants.RDF_NAMESPACE + "integer");
    public static final BaseDatatype RDF_TYPE_STRING =
            new BaseDatatype(OslcConstants.RDF_NAMESPACE + "string");
    public static final BaseDatatype RDF_TYPE_XMLLITERAL =
            new BaseDatatype(OslcConstants.RDF_NAMESPACE + "XMLLiteral");
    public static final BaseDatatype RDF_TYPE_RESOURCE =
            new BaseDatatype(OslcConstants.RDF_NAMESPACE + "Resource");
    public static final BaseDatatype RDF_TYPE_LOCALRESOURCE =
            new BaseDatatype(OslcConstants.RDF_NAMESPACE + "LocalResource");
