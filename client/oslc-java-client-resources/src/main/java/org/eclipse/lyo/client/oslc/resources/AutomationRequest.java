...
/**
 * @see <a href="https://archive.open-services.net/wiki/automation/OSLC-Automation-Specification-Version-2.0/index.html#Resource_AutomationRequest">https://archive.open-services.net/wiki/automation/OSLC-Automation-Specification-Version-2.0/index.html#Resource_AutomationRequest</a>
 */
@Deprecated
@OslcResourceShape(
...
public class AutomationRequest extends AbstractResource {
  ...
  @OslcDescription(
      "The person(s) who are responsible for the work needed to complete the automation request.")
  ...
  @OslcDescription(
      "Descriptive text (reference: Dublin Core) about resource represented as rich text in XHTML"
          + " content.")
