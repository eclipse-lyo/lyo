...
/**
 * @see <a href="https://archive.open-services.net/wiki/automation/OSLC-Automation-Specification-Version-2.0/index.html#Resource_AutomationResult">https://archive.open-services.net/wiki/automation/OSLC-Automation-Specification-Version-2.0/index.html#Resource_AutomationResult</a>
 */
@Deprecated
@OslcResourceShape(
    title = "Automation Result Resource Shape",
    describes = AutomationConstants.TYPE_AUTOMATION_RESULT)
@OslcNamespace(AutomationConstants.AUTOMATION_NAMESPACE)
public class AutomationResult extends AbstractResource {
  ...
  @OslcDescription(
      "The person(s) who are responsible for the work needed to complete the automation result.")
  ...
  @OslcDescription(
      "A unique identifier for a resource. Assigned by the service provider when a resource is"
          + " created. Not intended for end-user display.")
  ...
  @OslcDescription(
      "Title (reference: Dublin Core) or often a single line summary of the resource represented as"
  ...
  @OslcDescription(
      "Used to indicate the state of the automation result based on values defined by the service"
          + " provider.")
  ...
  @OslcDescription(
      "A copy of the parameters provided during creation of the Automation Request which produced"
  ...
  @OslcDescription(
      "Automation Result output parameters are parameters associated with the automation execution"
          ...
          + " during automation execution by the service provider or external agents.")
  @OslcOccurs(Occurs.ZeroOrMany)
