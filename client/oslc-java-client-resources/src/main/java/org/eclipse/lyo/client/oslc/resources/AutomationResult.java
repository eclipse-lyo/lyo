...
public class AutomationResult extends AbstractResource {
    ...
    @OslcDescription(
            "Used to indicate the state of the automation result based on values defined by the"
                    + " service provider.")
    ...
    @OslcPropertyDefinition(
            AutomationConstants.AUTOMATION_NAMESPACE + "producedByAutomationRequest")
    ...
    @OslcDescription(
            "A copy of the parameters provided during creation of the Automation Request which"
                    + " produced this Automation Result.")
    @OslcOccurs(Occurs.ZeroOrMany)
