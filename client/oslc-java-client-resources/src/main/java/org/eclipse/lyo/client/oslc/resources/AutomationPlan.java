...
/**
 * @see <a href="https://archive.open-services.net/wiki/automation/OSLC-Automation-Specification-Version-2.0/index.html#Resource_AutomationPlan">https://archive.open-services.net/wiki/automation/OSLC-Automation-Specification-Version-2.0/index.html#Resource_AutomationPlan</a>
 */
@Deprecated
@OslcResourceShape(
    title = "Automation Plan Resource Shape",
    describes = AutomationConstants.TYPE_AUTOMATION_PLAN)
@OslcNamespace(AutomationConstants.AUTOMATION_NAMESPACE)
public class AutomationPlan extends AbstractResource {
  ...
  @OslcDescription(
      "The person(s) who are responsible for the work needed to complete the automation plan.")
