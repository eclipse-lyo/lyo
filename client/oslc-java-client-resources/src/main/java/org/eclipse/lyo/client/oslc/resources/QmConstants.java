...
public interface QmConstants {
    ...
    public static String SOFTWARE_CONFIGURATION_MANAGEMENT_NAMESPACE =
    ...
    public static String TYPE_CHANGE_SET =
            SOFTWARE_CONFIGURATION_MANAGEMENT_NAMESPACE + "ChangeSet";
    ...
    public static String TYPE_TEST_EXECUTION_RECORD =
            QUALITY_MANAGEMENT_NAMESPACE + "TestExecutionRecord";
