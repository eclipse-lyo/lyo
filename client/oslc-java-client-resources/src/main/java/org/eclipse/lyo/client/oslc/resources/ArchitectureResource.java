...
@Deprecated
@OslcResourceShape(
    title = "Architecture Management Resource Resource Shape",
    describes = ArchitectureConstants.TYPE_ARCHITECTURE_RESOURCE)
@OslcNamespace(ArchitectureConstants.ARCHITECTURE_NAMESPACE)
@OslcName(ArchitectureConstants.ARCHITECTURE_RESOURCE)
public class ArchitectureResource extends AbstractResource {
  ...
  @OslcDescription(
      "The resource URI a client can perform a get on to obtain the original non-OSLC AM formatted"
