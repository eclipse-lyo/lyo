...
public class OslcOAuthClientBuilder {
    ...
    public OslcOAuthClientBuilder setOAuthServiceProvider(
            String requestTokenURL, String authorizationTokenURL, String accessTokenURL) {
    ...
    public OslcOAuthClientBuilder setOAuthConsumer(
            String callback, String consumerKey, String consumerSecret) {
    ...
    public OslcOAuthClientBuilder setUnderlyingHttpClient(
    ...
    public IOslcClient build() {
        OAuthServiceProvider oAuthServiceProvider =
                new OAuthServiceProvider(requestTokenURL, authorizationTokenURL, accessTokenURL);
        OAuthConsumer oAuthConsumer =
                new OAuthConsumer(callback, consumerKey, consumerSecret, oAuthServiceProvider);
        OAuthAccessor oauthAccessor = new OAuthAccessor(oAuthConsumer);
        return new OslcOAuthClient(
                oauthAccessor, oauthRealmName, clientBuilder, underlyingHttpClient);
    }
}
