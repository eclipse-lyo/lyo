...
public class OslcClientTest {
        ...
        assertTimeout(
                ...
                () -> {
                    ...
                    request.getExtendedProperties()
                            .put(new QName("http://example.com/ns#", "test"), "test");
                    Response response =
    ...
    public void testGetResource() {
        ...
        doReturn(null)
                .when(client)
                .doRequest(any(), any(), any(), any(), any(), any(), any(), any());
        client.getResource("test.url");
        verify(client)
                .doRequest("GET", "test.url", null, null, null, null, "application/rdf+xml", null);
    ...
    public void testPutResource() {
        ...
        verify(client)
                .doRequest(
                        "PUT", "test.url", "artifact", null, null, "application/json", "*/*", null);
    ...
    public void testDeleteResource() {
        ...
        verify(client)
                .doRequest("DELETE", "test.url", null, "configContext", null, null, null, null);
    }
    ...
    public void testAddHeaders() {
        ...
        Map<String, String> headers =
                client.addHeaders(builder, Map.of("a", "b"), "ifmatch", "ctx");
