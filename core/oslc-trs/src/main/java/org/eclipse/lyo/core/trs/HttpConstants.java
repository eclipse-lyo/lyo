...
public class HttpConstants {
    ...
    public static final String X_JAZZ_AUTHORIZATION_GUIDANCE =
            "X-Jazz-Authorization-Guidance"; //$NON-NLS-1$
    ...
    public static final String CT_APPLICATION_JSONREQUEST =
            "application/jsonrequest"; //$NON-NLS-1$
    ...
    public static final String CT_APPLICATION_SPARQL_QUERY =
            "application/sparql-query"; //$NON-NLS-1$
    ...
    public static final String CT_APPLICATION_SPARQL_RESULTS_XML =
            "application/sparql-results+xml"; //$NON-NLS-1$
    ...
    public enum HttpMethod {
        ...
        public static HttpMethod fromString(String name) {
            ...
            for (HttpMethod mType : HttpMethod.values()) {
                if (mType.toString().equalsIgnoreCase(name)) return mType;
            }
            return null;
        }
