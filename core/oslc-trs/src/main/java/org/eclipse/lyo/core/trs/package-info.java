...
@OslcSchema({
    ...
    @OslcNamespaceDefinition(
            prefix = TRSConstants.TRS_NAMESPACE_PREFIX,
            namespaceURI = TRSConstants.TRS_NAMESPACE),
    @OslcNamespaceDefinition(
            prefix = TRSConstants.LDP_NAMESPACE_PREFIX,
            namespaceURI = TRSConstants.LDP_NAMESPACE),
    @OslcNamespaceDefinition(
            prefix = TRSConstants.XSD_NAMESPACE_PREFIX,
            namespaceURI = TRSConstants.XSD_NAMESPACE)
})
