...
public class RdfJenaProviderCollectionTest extends JerseyTest {
  ...
  public void testArrayNonQuery(
    ...
    assertThat(response.getStatusInfo().getFamily()).isEqualTo(Response.Status.Family.SUCCESSFUL);
    //        Object[] rdfResponse = response.readEntity(((Object[]) Array.newInstance(Object.class,
    // 0)).getClass());
    TestResourceNonQ[] rdfResponse =
        response.readEntity(
            ((TestResourceNonQ[]) Array.newInstance(TestResourceNonQ.class, 0)).getClass());
  ...
  private static class ProviderCollectionTestArguments implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext)
      ...
      for (String mimeType :
        ...
        builder.accept(
            Arguments.of("/test/qc-array-method-rdf", true, TestResource.class, mimeType));
        builder.accept(
            Arguments.of("/test/qc-array-response-rdf", true, TestResource.class, mimeType));
        builder.accept(
            Arguments.of("/test/qc-coll-method-rdf", true, TestResource.class, mimeType));
        builder.accept(
            Arguments.of("/test/qc-coll-response-rdf", true, TestResource.class, mimeType));
        builder.accept(
            Arguments.of(
                "/test/nonqc-array-response-rdf", false, TestResourceNonQ.class, mimeType));
        builder.accept(
            Arguments.of(
                "/test/nonqc-nonq-coll-response-rdf", false, TestResourceNonQ.class, mimeType));
        builder.accept(
            Arguments.of(
                "/test/qc-nonq-coll-response-rdf", false, TestResourceNonQ.class, mimeType));
        builder.accept(
            Arguments.of(
                "/test/qc-nonq-array-response-rdf", false, TestResourceNonQ.class, mimeType));
      }
