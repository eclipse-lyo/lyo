...
public class UnparseableLiteralTest {
    ...
    public void testParseTheUnparseable() throws Exception {
        ...
        verifyUnparseable(
                resource,
                new QName(DCTerms.NS, "identifier"),
                "thirteen",
                "http://www.w3.org/2001/XMLSchema#int");
        verifyUnparseable(
                resource,
                new QName(TestResource.TEST_NAMESPACE, "age"),
                "",
                "http://www.w3.org/2001/XMLSchema#long");
        verifyUnparseable(
                resource,
                new QName(DCTerms.NS, "modified"),
                "yesterday",
    ...
    public void serializeUnparseable() throws Exception {
        ...
        final Statement ageStatement =
                serialized.getProperty(m.createProperty(TestResource.TEST_NAMESPACE + "age"));
        ...
        assertEquals(
                "Unexpected value for dcterms:modified", "today", modifiedStatement.getString());
        // Since Jena 3 an uninitialised literal is an empty string, not a null anymore
        //		assertNull(modifiedStatement.getLiteral().getDatatypeURI());
    }

    private void verifyUnparseable(
            TestResource resource, QName property, String expectedValue, String expectedType) {
        final Map<QName, Object> extended = resource.getExtendedProperties();
        final Object o = extended.get(property);
        assertTrue(
                "Expected UnparseableLiteral for property " + property,
