...
@OslcResourceShape(
        ...
        describes = OslcConstants.TYPE_SERVICE_PROVIDER_CATALOG)
public class ServiceProviderCatalog extends AbstractResource {
    ...
    @OslcValueShape(
            OslcConstants.PATH_RESOURCE_SHAPES + "/" + OslcConstants.PATH_SERVICE_PROVIDER_CATALOG)
    public URI[] getReferencedServiceProviderCatalogs() {
        return referencedServiceProviderCatalogs.toArray(
                new URI[referencedServiceProviderCatalogs.size()]);
    }
    ...
    public void setReferencedServiceProviderCatalogs(
            final URI[] referencedServiceProviderCatalogs) {
        this.referencedServiceProviderCatalogs.clear();
        if (referencedServiceProviderCatalogs != null) {
            this.referencedServiceProviderCatalogs.addAll(
                    Arrays.asList(referencedServiceProviderCatalogs));
        }
    }
