...
@OslcResourceShape(
        title = "OSLC Extended Error Resource Shape",
        describes = OslcConstants.TYPE_EXTENDED_ERROR)
public class ExtendedError {
    ...
    @OslcDescription(
            "If present and set to 'alternate' then indicates that work-around is provided,"
