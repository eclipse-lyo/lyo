...
public final class Property extends AbstractResource implements Comparable<Property> {
   ...
   */
  @OslcDescription(
      "Description of the property. SHOULD include only content that is valid and suitable inside"
   ...
   */
  @OslcDescription(
      "For String properties only, specifies maximum characters allowed. If not set, then there is"
          + " no maximum or maximum is specified elsewhere")
   ...
   */
  @OslcDescription(
      "For properties with a resource value-type, Providers MAY also specify the range of possible"
          + " resource classes allowed, each specified by URI. The default range is"
  ...
  @OslcDescription(
      "Should be http://open-services.net/ns/core#Reference,"
          + " http://open-services.net/ns/core#Inline or http://open-services.net/ns/core#Either")
   ...
   */
  @OslcDescription(
      "Title of the property. SHOULD include only content that is valid and suitable inside an"
          + " XHTML <div> element")
   ...
   */
  @OslcDescription(
      "if the value-type is a resource type, then Property MAY provide a shape value to indicate"
          + " the Resource Shape that applies to the resource")
   ...
   */
  @OslcDescription(
      "If set to true, this indicates that the property is a membership property, as described in"
          + " the Query Syntax Specification: Member List Patterns. This is useful when the"
          + " resource whose shape is being defined is viewed as a container of other resources."
          + " For example, look at the last example in Appendix B's RDF/XML Representation"
          + " Examples: Specifying the shape of a query result, where blog:comment is defined as a"
          + " membership property and comment that matches the query is returned as value of that"
          + " property.")
  ...
  @OslcDescription(
      "true if the property is read-only. If not set, or set to false, then the property is"
          + " writable. Providers SHOULD declare a property read-only when changes to the value of"
          + " that property will not be accepted on PUT. Consumers should note that the converse"
          + " does not apply: Providers MAY reject a change to the value of a writable property.")
