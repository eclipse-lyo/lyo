...
@OslcResourceShape(
        ...
        describes = OslcConstants.TYPE_CREATION_FACTORY)
public class CreationFactory extends AbstractResource {
    ...
    @OslcDescription(
            "A creation factory may provide resource shapes that describe shapes of resources that"
                    + " may be created")
    ...
    @OslcDescription(
            "The expected resource type URI of the resource that will be created using this"
                    + " creation factory. These would be the URIs found in the result resource's"
                    + " rdf:type property")
    ...
    @OslcDescription(
            "An identifier URI for the domain specified usage of this creation factory. If a"
                + " service provides multiple creation factories, it may designate the primary or"
