...
public interface OslcConstants {
    ...
    public static final String OSLC_DATA_NAMESPACE =
    ...
    public static final String TYPE_O_AUTH_CONFIGURATION =
            OSLC_CORE_NAMESPACE + "OAuthConfiguration";
    ...
    public static final String TYPE_SERVICE_PROVIDER_CATALOG =
