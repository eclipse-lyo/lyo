...
public class QueryUtils {
     ...
     * @throws ParseException
     */
    public static WhereClause parseWhere(String whereExpression, Map<String, String> prefixMap)
            throws ParseException {
        ...
        try {
            ...
            return (WhereClause)
                    Proxy.newProxyInstance(
                            CompoundTerm.class.getClassLoader(),
                            new Class<?>[] {CompoundTerm.class, WhereClause.class},
                            new CompoundTermInvocationHandler(rawTree, true, prefixMap));
     ...
     * @throws ParseException
     */
    public static SelectClause parseSelect(String selectExpression, Map<String, String> prefixMap)
            throws ParseException {
        ...
        try {
            ...
            return (SelectClause)
                    Proxy.newProxyInstance(
                            SelectClause.class.getClassLoader(),
                            new Class<?>[] {SelectClause.class, Properties.class},
                            new PropertiesInvocationHandler(resultTree.getTree(), prefixMap));
     ...
     * @throws ParseException
     */
    public static PropertiesClause parseProperties(
            String propertiesExpression, Map<String, String> prefixMap) throws ParseException {
        ...
        try {
            ...
            return (PropertiesClause)
                    Proxy.newProxyInstance(
                            PropertiesClause.class.getClassLoader(),
    ...
    public static OrderByClause parseOrderBy(
            String orderByExpression, Map<String, String> prefixMap) throws ParseException {
        ...
        try {
            ...
            return (OrderByClause)
                    Proxy.newProxyInstance(
                            OrderByClause.class.getClassLoader(),
     ...
     */
    public static Map<String, Object> invertSelectedProperties(final Properties properties) {
        ...
        for (Property property : children) {
            ...
            switch (property.type()) {
                case IDENTIFIER:
                    if (property.isWildcard()) {
                        ...
                        if (result instanceof NestedWildcardProperties) {
                            result =
                                    new BothWildcardPropertiesImpl(
                    ...
                    result.put(propertyName, OSLC4JConstants.OSL4J_PROPERTY_SINGLETON);
                ...
                case NESTED_PROPERTY:
                    ...
                    result.put(propertyName, invertSelectedProperties((NestedProperty) property));
        ...
        for (Map.Entry<String, Object> propertyMapping : result.entrySet()) {
            ...
            Map<String, Object> nestedProperties = (Map<String, Object>) propertyMapping.getValue();
     ...
     */
    private static class SingletonWildcardPropertiesImpl extends HashMap<String, Object>
     ...
     */
    private static class NestedWildcardPropertiesImpl extends HashMap<String, Object>
        ...
        protected Map<String, Object> commonNestedProperties = new HashMap<>();
     ...
     */
    private static class BothWildcardPropertiesImpl extends NestedWildcardPropertiesImpl
            implements SingletonWildcardProperties {
    ...
    private static void mergePropertyMaps(Map<String, Object> lhs, Map<String, Object> rhs) {
        ...
        for (String propertyName : rhs.keySet()) {
            ...
            @SuppressWarnings("unchecked")
            Map<String, Object> lhsNestedProperties = (Map<String, Object>) lhs.get(propertyName);
            @SuppressWarnings("unchecked")
            Map<String, Object> rhsNestedProperties = (Map<String, Object>) rhs.get(propertyName);
