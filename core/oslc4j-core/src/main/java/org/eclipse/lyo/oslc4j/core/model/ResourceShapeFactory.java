...
public class ResourceShapeFactory {
    ...
    private static Property createProperty(
        ...
        final Property property =
                new Property(name, occurs, new URI(propertyDefinition), valueType);
        ...
        validateUserSpecifiedValueType(
                resourceClass, method, valueType, representation, componentType);
    ...
    protected static void validateSetMethodExists(
        ...
        if (!isCollectionType(returnType)) {
            ...
            if (parameterTypes == null || parameterTypes.length == 0 || parameterTypes.length > 1) {
                throw new IllegalArgumentException(
                        String.format(
                                "Method '%s' shall have exactly one argument", method.getName()));
            }
    ...
    protected static void validateUserSpecifiedValueType(
        ...
        if ((userSpecifiedValueType.equals(calculatedValueType))
                ...
                || (ValueType.Resource.equals(userSpecifiedValueType)
                        && (null != userSpecifiedRepresentation)
