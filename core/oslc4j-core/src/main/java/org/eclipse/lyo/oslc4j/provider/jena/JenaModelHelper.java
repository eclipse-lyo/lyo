...
public final class JenaModelHelper {
    ...
    /**
     * Wrapper around {@link #fromJenaResource(Resource, Class)} to provide generics support and
     * group exceptions.
     *
     ...
     * @throws LyoModelException if the model cannot be unmarshalled into instances of the provided
     *     class
     */
     ...
     *
     * <p>Useful in case of following links of a just unmarshaled resource using {@link
                    ...
                    if (extendedProperties == null) {
                        ...
                        final Object value =
                                handleExtendedPropertyValue(
                                        beanClass, statement, visitedResources, key, rdfTypes);
    ...
    /**
     * Returns a hash set of rdf:types for a given resource object. If the set was populated before,
     * returns the given list. This list will only be populated if the property inferTypeFromShape
     * is set to true.
     *
     * @param resource
     * @param types
    ...
    /**
     * Generates a prefix for unrecognized namespaces when reading in unknown properties and
     * content.
     *
    ...
    private static Object constructReifiedResource(
        ...
        for (Statement reifiedStatement : collectedProps) {
            ...
            Object value =
                    handleExtendedPropertyValue(
                            beanClass, reifiedStatement, visitedResources, key, rdfTypes);
    ...
    private static void addReifiedStatements(
        ...
        var reifiedJenaResource =
                model.createResource(AnonId.create(reifiedNode.getBlankNodeLabel()));
