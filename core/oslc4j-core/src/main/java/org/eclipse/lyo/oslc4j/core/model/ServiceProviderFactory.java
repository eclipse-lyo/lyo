...
public final class ServiceProviderFactory {
    ...
    public static ServiceProvider createServiceProvider(
            ...
            final Publisher publisher,
            final Class<?>[] resourceClasses,
            final Map<String, Object> pathParameterValues)
            throws OslcCoreApplicationException, URISyntaxException {
        return initServiceProvider(
                new ServiceProvider(),
                baseURI,
    ...
    public static ServiceProvider initServiceProvider(
        ...
        for (final Class<?> resourceClass : resourceClasses) {
            ...
            if (initPathParameterValues == null) {
                log.warn(
                        "pathParameterValues passed to ServiceProviderFactory.initServiceProvider()"
                                + " SHALL NOT be null");
                initPathParameterValues = new HashMap<>();
            }
            handleResourceClass(
                    baseURI, genericBaseURI, resourceClass, service, initPathParameterValues);
        }
    ...
    private static void handleResourceClass(
            final String baseURI,
            final String genericBaseURI,
        ...
        for (final Method method : resourceClass.getMethods()) {
            ...
            if (getAnnotation != null) {
                final OslcQueryCapability queryCapabilityAnnotation =
                        method.getAnnotation(OslcQueryCapability.class);
                String[] resourceShapes = null;
                if (queryCapabilityAnnotation != null) {
                    service.addQueryCapability(
                            createQueryCapability(baseURI, method, pathParameterValues));
                ...
                if (postAnnotation != null) {
                    final OslcCreationFactory creationFactoryAnnotation =
                            method.getAnnotation(OslcCreationFactory.class);
                    String[] resourceShapes = null;
                    if (creationFactoryAnnotation != null) {
                        service.addCreationFactory(
                                createCreationFactory(baseURI, pathParameterValues, method));
    ...
    static CreationFactory createCreationFactory(
            final String baseURI,
            final Map<String, Object> pathParameterValues,
            final Method method)
            throws URISyntaxException {
    ...
    static CreationFactory createCreationFactory(
            final String baseURI,
            final Map<String, Object> pathParameterValues,
            final Path classPathAnnotation,
            final OslcCreationFactory creationFactoryAnnotation,
    ...
    private static QueryCapability createQueryCapability(
            final String baseURI,
            final Method method,
            final Map<String, Object> pathParameterValues)
            throws URISyntaxException {
    ...
    private static Dialog createCreationDialog(
            final String baseURI,
            final String genericBaseURI,
            final Method method,
            final OslcDialog dialogAnnotation,
    ...
    private static Dialog createSelectionDialog(
            final String baseURI,
            final String genericBaseURI,
            final Method method,
            final OslcDialog dialogAnnotation,
        ...
        if (dialogURI.length() > 0) {
            ...
            if (resourceShapes != null) {
                for (final String resourceShape : resourceShapes) {
                    ...
                    try {
                        final String encodedResourceShape =
                                URLEncoder.encode(resourceShapeURI, "UTF-8");

                        resourceShapeParameters
                                .append("&resourceShape=")
                                .append(encodedResourceShape);
                    } catch (final UnsupportedEncodingException exception) {
                        // TODO Andrew@2017-07-18: Rethrow an exception
    ...
    private static String resolvePathParameters(
            ...
            final String classPathAnnotation,
            final String methodPathAnnotation,
            final Map<String, Object> pathParameterValues) {
        ...
        log.warn(
                "Could not build a path URI for basePath={} and path annotations"
                        + " (class='{}',method='{}')",
                basePath,
                classPathAnnotation,
                methodPathAnnotation);
