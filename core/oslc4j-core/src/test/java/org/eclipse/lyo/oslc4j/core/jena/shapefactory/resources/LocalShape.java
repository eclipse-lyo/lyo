    ...
    implements ILocalShape
{
    ...
    public LocalShape(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        Oslc_sdDomainConstants.LOCALSHAPE_PATH,
        LocalShape.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local LocalShape Resource} - update LocalShape.toString() to present resource as desired.";
