...
public final class JsonHelper {
    ...
    private static final String RDF_ABOUT_URI =
            OslcConstants.RDF_NAMESPACE + JSON_PROPERTY_SUFFIX_ABOUT;
    private static final String RDF_TYPE_URI =
            OslcConstants.RDF_NAMESPACE + JSON_PROPERTY_SUFFIX_TYPE;
    private static final String RDF_NIL_URI =
            OslcConstants.RDF_NAMESPACE + JSON_PROPERTY_SUFFIX_NIL;
    private static final String RDF_RESOURCE_URI =
            OslcConstants.RDF_NAMESPACE + JSON_PROPERTY_SUFFIX_RESOURCE;
    ...
    public static final String OSLC4J_WRITE_SPECIAL_NUMS =
            "org.eclipse.lyo.oslc4j.writeSpecialNumberValues";
    ...
    public static final String OSLC4J_READ_SPECIAL_NUMS =
            "org.eclipse.lyo.oslc4j.readSpecialNumberValues";
    ...
    public static JSONObject createJSON(
        ...
        Map<String, String> globalPrefixDefinitionMap =
                OslcGlobalNamespaceProvider.getInstance().getPrefixDefinitionMap();
        for (Map.Entry<String, String> prefixDefinitionEntry :
                globalPrefixDefinitionMap.entrySet()) {
            namespaceMappings.put(prefixDefinitionEntry.getKey(), prefixDefinitionEntry.getValue());
            reverseNamespaceMappings.put(
                    prefixDefinitionEntry.getValue(), prefixDefinitionEntry.getKey());
        }
        ...
        if (descriptionAbout != null) {
            ...
            resultJSONObject.put(
                    rdfPrefix + JSON_PROPERTY_DELIMITER + JSON_PROPERTY_SUFFIX_ABOUT,
                    descriptionAbout);
            ...
            if (OSLC4JUtils.isQueryResultListAsContainer()) {
                ...
                containerTypeJSONObject.put(
                        rdfPrefix + JSON_PROPERTY_DELIMITER + JSON_PROPERTY_SUFFIX_RESOURCE,
                        OslcConstants.TYPE_CONTAINER);

                containerTypesJSONArray.add(containerTypeJSONObject);

                resultJSONObject.put(
                        rdfPrefix + JSON_PROPERTY_DELIMITER + JSON_PROPERTY_SUFFIX_TYPE,
            ...
            resultJSONObject.put(
                    rdfsPrefix + JSON_PROPERTY_DELIMITER + JSON_PROPERTY_SUFFIX_MEMBER, jsonArray);

            if (responseInfoAbout != null) {
                // Ensure we have an oslc prefix
                final String oslcPrefix =
                        ensureNamespacePrefix(
                ...
                responseInfoJSONObject.put(
                        rdfPrefix + JSON_PROPERTY_DELIMITER + JSON_PROPERTY_SUFFIX_ABOUT,
                        responseInfoAbout);

                if (responseInfo != null) {
                    responseInfoJSONObject.put(
                            oslcPrefix + JSON_PROPERTY_DELIMITER + JSON_PROPERTY_SUFFIX_TOTAL_COUNT,
                    ...
                    if (responseInfo.nextPage() != null) {
                        ...
                        nextPageJSONObject.put(
                                rdfPrefix + JSON_PROPERTY_DELIMITER + JSON_PROPERTY_SUFFIX_RESOURCE,
                                responseInfo.nextPage());
                        responseInfoJSONObject.put(
                                oslcPrefix
                                        + JSON_PROPERTY_DELIMITER
                                        + JSON_PROPERTY_SUFFIX_NEXT_PAGE,
                                nextPageJSONObject);
                    }
                    ...
                    responseInfoTypeJSONObject.put(
                            rdfPrefix + JSON_PROPERTY_DELIMITER + JSON_PROPERTY_SUFFIX_RESOURCE,
                    ...
                    resultJSONObject.put(
                            oslcPrefix
                                    + JSON_PROPERTY_DELIMITER
                                    + JSON_PROPERTY_SUFFIX_RESPONSE_INFO,
        ...
        for (final Map.Entry<String, String> namespaceMapping : namespaceMappings.entrySet()) {
            namespaces.put(namespaceMapping.getKey(), namespaceMapping.getValue());
        }

        if (namespaces.size() > 0) {
            resultJSONObject.put(JSON_PROPERTY_PREFIXES, namespaces);
        }

        return resultJSONObject;
    }

    public static Object[] fromJSON(final JSONObject jsonObject, final Class<?> beanClass)
            throws DatatypeConfigurationException,
                    IllegalAccessException,
                    IllegalArgumentException,
        ...
        // First read the prefixes and set up maps so we can create full property definition values
        // later
        ...
        if (prefixes instanceof JSONObject) {
            ...
            final Set<Map.Entry<String, Object>> prefixesEntrySet =
                    (Set<Map.Entry<String, Object>>) prefixesJSONObject.entrySet();
        ...
        if (rdfsPrefix != null) {
            final Object members =
                    jsonObject.opt(
                            rdfsPrefix + JSON_PROPERTY_DELIMITER + JSON_PROPERTY_SUFFIX_MEMBER);
        ...
        if (jsonArray == null) {
            ...
            final String oslcPrefix =
                    reverseNamespaceMappings.get(OslcConstants.OSLC_CORE_NAMESPACE);
    ...
    private static void buildAttributeResource(
        ...
        if (returnType.isArray()) {
            ...
            // We cannot cast to Object[] in case this is an array of primitives.  We will use Array
            // reflection instead.
            // Strange case about primitive arrays:	 they cannot be cast to Object[], but retrieving
            // their individual elements
            // does not return primitives, but the primitive object wrapping counterparts like
            // Integer, Byte, Double, etc.
            final int length = Array.getLength(value);
            for (int index = 0; index < length; index++) {
                final Object object = Array.get(value, index);

                final Object localResource =
                        handleLocalResource(
                                namespaceMappings,
                                reverseNamespaceMappings,
                                resourceClass,
    ...
    private static Object buildContainer(
            final Map<String, String> namespaceMappings,
            final Map<String, String> reverseNamespaceMappings,
            final OslcRdfCollectionType collectionType,
        ...
        if (JSON_PROPERTY_SUFFIX_LIST.equals(collectionType.collectionType())) {
            ...
            for (int i = jsonArray.size() - 1; i >= 0; i--) {
                ...
                newListObject.put(
                        rdfPrefix + JSON_PROPERTY_DELIMITER + JSON_PROPERTY_SUFFIX_FIRST, o);
                newListObject.put(
        ...
        container.put(
                rdfPrefix + JSON_PROPERTY_DELIMITER + collectionType.collectionType(), jsonArray);
        ...
        if (rdfPrefix != null) {
            ...
            if (objectClass.getAnnotation(OslcResourceShape.class) != null) {
                ...
                if (qualifiedName != null) {
                    addType(rdfPrefix, rdfTypesJSONArray, qualifiedName);
                }
            } else {
                qualifiedName = null;
            }
            ...
            if (object instanceof IExtendedResource) {
                ...
                for (final URI type : extendedResource.getTypes()) {
                    ...
                    if (!typeString.equals(qualifiedName)) {
                        addType(rdfPrefix, rdfTypesJSONArray, typeString);
                    }
                }
            }
    ...
    private static void addType(
            final String rdfPrefix, final JSONArray rdfTypesJSONArray, final String typeURI)
            throws JSONException {
        final JSONObject rdfTypeJSONObject = new JSONObject();
        rdfTypeJSONObject.put(
                rdfPrefix + JSON_PROPERTY_DELIMITER + JSON_PROPERTY_SUFFIX_RESOURCE, typeURI);
    ...
    protected static void addExtendedProperties(
            final Map<String, String> namespaceMappings,
            final Map<String, String> reverseNamespaceMappings,
            final JSONObject jsonObject,
        ...
        for (Map.Entry<QName, Object> extendedProperty :
            ...
            if (properties != null) {
                @SuppressWarnings("unchecked")
                final Map<String, Object> map =
                        (Map<String, Object>) properties.get(namespace + localName);
            ...
            if (value == null && !onlyNested) {
                logger.warn(
                        "Could not add extended property "
                                + extendedProperty.getKey()
                                + " for resource "
                                + extendedResource.getAbout());
            } else {
    ...
    private static Object getExtendedPropertyJsonValue(
            final Map<String, String> namespaceMappings,
            final Map<String, String> reverseNamespaceMappings,
            final Object object,
            final Map<String, Object> nestedProperties,
        ...
        if (object instanceof Collection) {
            ...
            return handleResourceReference(
                    namespaceMappings, reverseNamespaceMappings, resourceClass, null, (URI) object);
        } else if (object instanceof IResource && !visitedObjects.containsKey(object)) {
            return handleSingleResource(
                    object,
                    new JSONObject(),
                    namespaceMappings,
                    reverseNamespaceMappings,
    ...
    private static Object handleLocalResource(
            final Map<String, String> namespaceMappings,
            final Map<String, String> reverseNamespaceMappings,
            final Class<?> resourceClass,
            final Method method,
    ...
    private static Object handleReifiedResource(
            final Map<String, String> namespaceMappings,
            final Map<String, String> reverseNamespaceMappings,
            final Class<?> resourceClass,
            final Method method,
        ...
        if (!(value instanceof URI)) {
            ...
            throw new OslcCoreInvalidPropertyTypeException(
                    resourceClass, method, method.getReturnType());
        }
    ...
    protected static JSONObject handleResourceReference(
            final Map<String, String> namespaceMappings,
            final Map<String, String> reverseNamespaceMappings,
            final Class<?> resourceClass,
            final Method method,
            final URI uri)
            throws OslcCoreRelativeURIException, JSONException {
    ...
    private static JSONObject handleSingleResource(
            final Object object,
            final JSONObject jsonObject,
            final Map<String, String> namespaceMappings,
            final Map<String, String> reverseNamespaceMappings,
        ...
        if (object instanceof URI) {
            ...
            recursivelyCollectNamespaceMappings(
                    namespaceMappings, reverseNamespaceMappings, objectClass);
    ...
    protected static void addAboutURI(
            final JSONObject jsonObject,
            final Map<String, String> namespaceMappings,
            final Map<String, String> reverseNamespaceMappings,
    ...
    private static String ensureNamespacePrefix(
            final String prefix,
            final String namespace,
            final Map<String, String> namespaceMappings,
            final Map<String, String> reverseNamespaceMappings) {
    ...
    private static void recursivelyCollectNamespaceMappings(
        ...
        final OslcSchema oslcSchemaAnnotation =
                objectClass.getPackage().getAnnotation(OslcSchema.class);
            ...
            if (!customNamespaceProvider.isInterface()) {
                try {
                    ...
                    if (null != customNamespacePrefixes) {
                        for (Map.Entry<String, String> namespaceEntry :
                                customNamespacePrefixes.entrySet()) {
                            namespaceMappings.put(
                                    namespaceEntry.getKey(), namespaceEntry.getValue());
                            reverseNamespaceMappings.put(
                                    namespaceEntry.getValue(), namespaceEntry.getKey());
                        }
                    }
        ...
        if (superClass != null) {
            recursivelyCollectNamespaceMappings(
                    namespaceMappings, reverseNamespaceMappings, superClass);
        }
        ...
        if (interfaces != null) {
            for (final Class<?> interfac : interfaces) {
                recursivelyCollectNamespaceMappings(
                        namespaceMappings, reverseNamespaceMappings, interfac);
            }
        }
    }
     ...
     */
    private static HashSet<String> getRdfTypesFromJsonObject(
            JSONObject jsonObject, String rdfPrefix, HashSet<String> types) {
                ...
                if (setMethod == null) {
                    if (RDF_ABOUT_URI.equals(propertyDefinition)
                        ...
                        if (extendedProperties == null) {
                            logger.debug(
                                    "Set method not found for object type:	"
                                            + beanClass.getName()
                                            + ", propertyDefinition:	"
                                            + propertyDefinition);
                        } else {
                            final QName qName = new QName(namespace, name, namespacePrefix);

                            final Object value =
                                    fromExtendedJSONValue(
                                            jsonValue,
                                            rdfPrefix,
                    ...
                    if (parameter != null) {
                        try {
                            setMethod.invoke(bean, new Object[] {parameter});
                        } catch (IllegalAccessException
                                | IllegalArgumentException
                                | InvocationTargetException e) {
                            logger.warn(
                                    "Failed to set property {}='{}' via '{}'",
                                    prefixedName,
                                    parameter,
                                    setMethod.getName());
                            throw e;
     ...
     * setter in the bean.
     */
    private static Object fromExtendedJSONValue(
        ...
        if (jsonValue instanceof JSONArray) {
            ...
            final Object resourceURIValue =
                    o.opt(rdfPrefix + JSON_PROPERTY_DELIMITER + JSON_PROPERTY_SUFFIX_RESOURCE);
            ...
            if (OSLC4JUtils.inferTypeFromShape()) {
                ...
                Object newObject =
                        OSLC4JUtils.getValueBasedOnResourceShapeType(
                                rdfTypes, propertyQName, jsonValue);
    ...
    protected static void fillInRdfType(
            final String rdfPrefix, final JSONObject jsonObject, final IExtendedResource resource)
    ...
    private static boolean isRdfListNode(
            final String rdfPrefix,
            final Class<?> beanClass,
        ...
        if (setMethodName.startsWith(METHOD_NAME_START_SET)) {
            String getMethodName =
                    METHOD_NAME_START_GET + setMethodName.substring(METHOD_NAME_START_GET_LENGTH);
            Method getMethod;
            try {
                ...
                String isMethodName =
                        METHOD_NAME_START_IS
                                + setMethodName.substring(METHOD_NAME_START_GET_LENGTH);
                try {
            ...
            final OslcRdfCollectionType collectionType =
                    InheritedMethodAnnotationHelper.getAnnotation(
                            getMethod, OslcRdfCollectionType.class);
    ...
    private static Object fromJSONValue(
            final String rdfPrefix,
            final Map<String, String> jsonNamespaceMappings,
            final Map<Class<?>, Map<String, Method>> classPropertyDefinitionsToSetMethods,
            final Class<?> beanClass,
        ...
        if (!isRdfContainerNode && jsonValue instanceof JSONObject) {
            ...
            try {
                container =
                        parent.optJSONArray(
                                rdfPrefix + JSON_PROPERTY_DELIMITER + JSON_PROPERTY_SUFFIX_ALT,
                                null);

                if (container == null) {
                    container =
                            parent.optJSONArray(
                                    rdfPrefix + JSON_PROPERTY_DELIMITER + JSON_PROPERTY_SUFFIX_BAG,
                                    null);
                }
                ...
                if (container == null) {
                    container =
                            parent.optJSONArray(
                                    rdfPrefix + JSON_PROPERTY_DELIMITER + JSON_PROPERTY_SUFFIX_SEQ,
                                    null);
                }
            } catch (JSONException e) {
                throw new IllegalArgumentException(e);
        ...
        if (!isRdfContainerNode && jsonValue instanceof JSONObject) {
            ...
            if (!IReifiedResource.class.isAssignableFrom(setMethodComponentParameterClass)) {
                ...
                final Object uriObject =
                        nestedJSONObject.opt(
                                rdfPrefix
                                        + JSON_PROPERTY_DELIMITER
                                        + JSON_PROPERTY_SUFFIX_RESOURCE);
            ...
            if (isRdfContainerNode && container == null) {
                ...
                while (listNode != null
                    ...
                    listNode =
                            listNode.optJSONObject(
                                    rdfPrefix
                                            + JSON_PROPERTY_DELIMITER
                                            + JSON_PROPERTY_SUFFIX_REST);
                }
            ...
            for (final Object jsonArrayEntryObject : jsonArray) {
                final Object parameterArrayObject =
                        fromJSONValue(
                                rdfPrefix,
                                jsonNamespaceMappings,
                                classPropertyDefinitionsToSetMethods,
            ...
            if (setMethodParameterClass.isArray()) {
                // To support primitive arrays, we have to use Array reflection to set individual
                // elements.	 We cannot use Collection.toArray.
                // Array.set will unwrap objects to their corresponding primitives.
                final Object array =
                        Array.newInstance(setMethodComponentParameterClass, jsonArray.size());
            ...
            // Not handled above. Let's try newInstance with possible failure.
                ...
                @SuppressWarnings("unchecked")
                final Collection<Object> tempCollection =
                        ((Collection<Object>) setMethodParameterClass.newInstance());
            ...
            if (Boolean.class == setMethodComponentParameterClass
            ...
            if (Double.TYPE == setMethodComponentParameterClass) {
                if (readSpecialNumberValues()) {
                    ...
                    throw new IllegalArgumentException(
                            "Null double value not allowed. You can change this behavior by setting"
                                    + " system property of "
            ...
            if (Float.TYPE == setMethodComponentParameterClass) {
                if (readSpecialNumberValues()) {
                    ...
                    throw new IllegalArgumentException(
                            "Null float value not allowed. You can change this behavior by setting"
                                    + " system property of "
                                    + OSLC4J_READ_SPECIAL_NUMS
                                    + " to true.");
                }
            ...
            if (Short.TYPE == setMethodComponentParameterClass
                ...
                throw new IllegalArgumentException(
                        "Null values not allowed for type " + setMethodComponentParameterClass);
            }
