...
public abstract class AbstractOslcRdfJsonProvider {
    private static final Logger logger =
            Logger.getLogger(AbstractOslcRdfJsonProvider.class.getName());
    ...
    protected static boolean isWriteable(
            final Class<?> klass,
    ...
    protected void writeTo(
        ...
        try {
            ...
            logger.log(
                    Level.FINE, MessageExtractor.getMessage("ErrorSerializingResource"), exception);
    ...
    protected static boolean isReadable(
            final Class<?> type,
            final MediaType requiredMediaType,
            final MediaType actualMediaType) {
    ...
    protected Object[] readFrom(
        ...
        try {
            ...
            throw new WebApplicationException(
                    exception, buildBadRequestResponse(exception, errorMediaType, map));
        }
    }
