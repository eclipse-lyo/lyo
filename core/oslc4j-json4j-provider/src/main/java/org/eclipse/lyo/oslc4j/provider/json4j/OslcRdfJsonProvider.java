...
public final class OslcRdfJsonProvider extends AbstractOslcRdfJsonProvider
        implements MessageBodyReader<Object>, MessageBodyWriter<Object> {
    private static final Logger log = LoggerFactory.getLogger(OslcRdfJsonProvider.class);
            ...
            if (actualTypeArguments[0] instanceof Class<?>) {
                ...
                if (actualTypeArguments.length == 1) {
                    if (actualTypeArguments[0] instanceof Class<?>) {
                        ...
                        log.error(
                                "GenericEntity<?>-based capture of entity generic type is not"
                                        + " supported");
                        return false;
                    } else {
                        return false;
