...
public class TestTypesRdfXml
	   extends TestTypesBase
{
	public TestTypesRdfXml()
	{
		super();
	}
	...
	{
		testRetrieveCompact(OslcMediaType.APPLICATION_X_OSLC_COMPACT_XML);
	}
	...
	{
		testRetrieveCollection(OslcMediaType.APPLICATION_RDF_XML);
	}

	public void testRetrieveError()
	{
		testRetrieveError(OslcMediaType.APPLICATION_RDF_XML);
	}

	public void testRetrieveMessageBodyWriterError()
	{
		testRetrieveMessageBodyWriterError(OslcMediaType.APPLICATION_RDF_XML);
	}
